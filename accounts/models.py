...
class WrittenReview(models.Model):
    ...
    name = models.CharField(max_length=100,null=True, blank=True)  # Reviewer name
    email = models.EmailField(null=True, blank=True)              # Reviewer email
    content = models.TextField(null=True, blank=True)             # Review content
